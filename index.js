...
function handleButtonClick(customName, customSurname, output) {
    return __awaiter(this, void 0, void 0, function () {
        var name, surname, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    name = customName.value.trim();
                    surname = customSurname.value.trim();
                    if (!(name && surname)) return [3 /*break*/, 2];
                    output.textContent = "".concat(name, " ").concat(surname);
                    return [4 /*yield*/, fetch("http://10.0.2.15:5267/api/data", {
                            method: "POST",
                            headers: {
